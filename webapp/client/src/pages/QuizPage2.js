          ...
          <Row type="flex" style={{ justifyContent: 'center' }}>
            <Col>
              <Card ref='res' style={{
                ...
                <br />
                <br />
                <div style={{ fontSize: '40px', color: 'white' }}>Ready to create your trip to {this.state.selectedDest[1]}? </div>
                <br />
                <br />
                <Button onClick={this.clickNextPage} shape='round' size='large' style={{ border: 'none', background: 'black', color: 'white', zoom: '150%', width: '100px' }}>Next</Button>
                <br />
                <br />
                <br />
        ...
        <Layout style={{ background: 'white', marginLeft: 200, minWidth: '800px' }}>
          ...
          <Content style={{ margin: '24px 24px 0', overflow: 'initial', textAlign: 'center', fontFamily: 'Work Sans' }}>
            <Row align='middle' justify='center'>
              <Col>
                <div style={{ fontSize: '50px', }}>When I visit {this.state.selectedDest[1]}, I want to... </div>
